...
def generate_launch_description():
    ...
    robots = [
        {
            'robot_name': 'drone_0',
            'scan_topic': '/world/obstacle/model/Lidar_drone_0/model/lidar_2d_v2/link/link/sensor/lidar_2d_v2/scan@sensor_msgs/msg/LaserScan@gz.msgs.LaserScan',
            'px4_odom_topic': '/fmu/out/vehicle_odometry',
        },
        {
            'robot_name': 'drone_1',
            'scan_topic': '/world/obstacle/model/Lidar_drone_1/model/lidar_2d_v2/link/link/sensor/lidar_2d_v2/scan@sensor_msgs/msg/LaserScan@gz.msgs.LaserScan',
